export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-100 to-pink-50 flex flex-col items-center py-10 px-4">
      <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl p-10 max-w-3xl w-full flex flex-col items-center border border-blue-100">
        <img
          src="https://avatars.githubusercontent.com/u/2842446?v=4"
          alt="Jean-Louis Guenego avatar"
          className="w-32 h-32 rounded-full border-4 border-blue-400 shadow-xl mb-6 hover:scale-105 transition-transform duration-300"
        />
        <h1 className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-500 to-pink-400 mb-2 text-center drop-shadow-lg">
          Jean-Louis GUENEGO
        </h1>
        <h2 className="text-xl text-gray-700 mb-6 text-center font-medium">IT Freelance · JLG Consulting · Torcy (France)</h2>
        <a
          href="http://www.jlg-consulting.com/"
          target="_blank"
          rel="noopener noreferrer"
          className="text-blue-500 underline mb-8 hover:text-purple-600 text-lg font-semibold"
        >
        ...
        <div className="w-full flex flex-col md:flex-row gap-8 mb-8">
          <div className="flex-1 bg-blue-50 rounded-xl p-6 shadow hover:shadow-lg transition">
            <h3 className="text-lg font-bold text-blue-600 mb-3">Compétences</h3>
          ...
          <div className="flex-1 bg-purple-50 rounded-xl p-6 shadow hover:shadow-lg transition">
        ...
        <div className="w-full flex flex-col md:flex-row gap-8 mb-8">
          ...
          <div className="flex-1 bg-blue-50 rounded-xl p-6 shadow hover:shadow-lg transition">
            <h3 className="text-lg font-bold text-blue-500 mb-3">Formations</h3>
            <ul className="list-disc list-inside text-gray-700 space-y-1">
        ...
        <div className="flex flex-wrap gap-4 mt-6">
          <a href="https://github.com/jlguenego?tab=repositories" className="bg-blue-500 text-white px-6 py-3 rounded-full shadow hover:bg-blue-700 transition font-semibold" target="_blank">Voir les dépôts GitHub</a>
          <a href="https://github.com/jlguenego?tab=projects" className="bg-purple-500 text-white px-6 py-3 rounded-full shadow hover:bg-purple-700 transition font-semibold" target="_blank">Projets</a>
        </div>
      </div>
